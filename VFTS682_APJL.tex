...
either (a) it formed in relative isolation % through a new mode of star formation
...
% to other massive stars with small proper motion errors in \emph{Gaia} DR2,
% it is possible to tentatively claim that
\todo{from here}
it is
...
Based on our results, we suggest that VFTS682 is the most massive
...
stars. Interpreting the kinematics of VFTS682 through the lens of their simulations
...
In \citet{lennon:18} we carried out a similar study on the fast
moving O-type stars in the region, and found two very massive runaway stars in the 30 Doradus region. One of them (VFTS 16)
...
origin of the other star (VFTS72) is less clear given its direction
of motion (cf.~\Figref{fig:dist}). The value of $\tau_\mathrm{kin}\simeq0.9$\,Myr we find for
VFTS682 is smaller than the
corresponding value for VFTS16 of $\sim$1.5\,Myr, possibly in tension with the apparent age of that star. This means that the more
massive VFTS682 was ejected later than VFTS16 from the same
cluster. We note that also Galactic clusters can eject massive stars,
and \emph{Gaia} data have been used to study the population
surrounding Westerlund 2 \citep[][]{drew:18}. 
