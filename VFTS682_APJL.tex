...
\citep{lada:03}, where massive stars are thought to reside in the
...
% N-body simulations % of fully segregated
% clusters with all massive stars in binaries
