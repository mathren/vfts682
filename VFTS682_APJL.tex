...
\hline
  ...
  %    \multicolumn{5}{l}{\emph{Position}} \\
    ...
    %  &RA &[degree] &  \phantom{-}84.73 % $\pm$  0.03
   %                     & \multirow{2}{*}{\cite{evans:11}}\\[5pt]
    %  &DEC & [degree] & -69.07 % $\pm$  0.05
     %                   & \\[5pt]
      ...
      &$\delta\mu_\mathrm{}$  &[$\masyr$] & \SdM{0.13}$\pm$\SdM{0.09} &  (1,4) \\
                 &$v_\mathrm{2d}$  &[$\kms$] & \SdM{32}$\pm$\SdM{21} & (1,4)\\  
                     &$\theta$  &[degrees] &  14.2$\pm$\SdM{xxx}  & (1,4)\\  
...
reliable. Generally, the Gaia errors are correlated
\citep[][]{lindengren:18}, but for this star the correlation coefficient is small, see Tab.~\ref{tab:vfts682}
...
% $\langle\mu_\mathrm{RA}\rangle = 1.7240\pm0.0002\masyr$ and
...
%     0.1, 0.2, and 0.4$\masyr$. Positive angle
