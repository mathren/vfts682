...
\title{Gaia's constraints on the origin of the  $\sim$$150\,M_\odot$ candidate runaway star VFTS682}
...
\begin{abstract}
  ...
  release together with multiepoch \emph{Hubble Space Telescope} proper motions to investigate the kinematics of this object. We show
...
% VFTS682.
\cite{bestenlehner:11} and \cite{bressert:12} discussed in this
context the case of the very massive star VFTS682.
This star is located in the field of the 30 Doradus region
...
origin of VFTS682: it either formed in situ as an isolated massive
star, or it is a slow runaway originating from R136. % Quoting directly 
...
analyze the \emph{Gaia} DR2 data for VFTS682 which
...
presence of an optically thick, non-homogeneous, and variable
wind obscuring the photosphere. The radial velocity errors quoted
above are only statistical, and do not quantify the (possibly larger)
systematic errors.% quantify only statistical uncertainties from the
