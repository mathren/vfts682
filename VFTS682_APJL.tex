...
\SdM{The star does not show clear radial velocity variations, which makes the presence of a close companion unlikely
 \citet{bestenlehner:11}.  There are also no indications for the presence of a companion based on observations with the Chandra X-Ray Observatory. 
The detection of a point source in X-rays could have pointed at the presence of a compact companion or a colliding wind binary \citep{townsley:06}. }
% 
