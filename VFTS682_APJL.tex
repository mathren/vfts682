...
for over-interpreting the radial velocities estimates. % , but we will summarize the estimates that have been published. 
...
LMC is probably much smaller ($\sim$$0.5\%$, e.g., \citealt{Luks+1992}). These uncertainties are negligible compared to the errors in the proper motion discussed below.  
...
that VFTS682 was ejected later than VFTS16, potentially at a time similar to VFTS72.
