...
to R136 from \emph{Gaia} DR2, selecting stars with small error bars only. Although VFTS682 is not peculiar, its relative proper motion
...
\begin{figure}%[tbp]
  \centering
  \includegraphics[width=0.48\textwidth]{./figures/Figure2_paper_vfts682_hst_corr_nor136err}  
