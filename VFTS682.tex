...
\todo{redo below with HST only and Gaia only?Redo also calculation
  of $v_\mathrm{pec}$}
...
$\delta\mu_\mathrm{RA}^{Gaia} = \pm \,\mathrm{mas\ yr^{-1}}$ and $\delta\mu_\mathrm{DEC}^{Gaia} =
\pm \,\mathrm{mas\ yr^{-1}}$. The error budget is
