...
VFTS682 from \emph{Gaia} DR2 (see \Eqref{eq:pm_gaia_around}), and the cyan arrows show the possible
range of directions within the uncertainties in the measured relative proper
motion. These arrows cross at the present-day location of VFTS682 and
...
\begin{figure}%[tbp]
  ...
  \caption{The red solid arrow indicates the proper motion of VFTS682
    ...
    times the kinetic age of VFTS682. % \todo{load color picture on background? Fig with HST data
