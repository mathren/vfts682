...
$\langle\mu_\mathrm{DEC}\rangle =0.6986\pm0.0003\,\mathrm{mas\ yr^{-1}}$. We note that these values are
...
$\mu_\mathrm{RA} = 0.12\pm 0.07\,\mathrm{mas\ yr^{-1}}$ and $\mu_\mathrm{DEC} =
0.08\pm 0.08\,\mathrm{mas\ yr^{-1}}$. We note that the error budget is
