...
likely to be foreground stars \todo{clean phrasing here}.
This selection yields 182 stars.% , including the subset of stars which we consider to be
...
% 1323 stars.
% A more strict sample selection for the surroundings can
