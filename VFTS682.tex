...
% in the International Celestial Reference System \cite[][]{brown:18},
% its
% proper motion components .
%  and for simplicity we treat them as
...
orange arrows illustrate the uncertainty. % show the possible
