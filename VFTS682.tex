   ...
   % Academy of Sciences, Beijing 100012, China}\\
    % $^4$ {National Astronomical Observatories, Chinese Academy of
     ...
     $^6$ {Department of Physics, University of Oxford, Keble Road,
       Oxford OX1 3RH, UK} \\
     $^7$ {Department of Physics and Astronomy, Hicks Building, Hounsfield Road, University of Sheffield, Sheffield S3 7RH, UK}
}
...
They commented that this is unusual for Wolf-Rayet and more reminiscent
...
not reduces further our sample. Finally, we remove clear outliers from
the proper motion distribution 
