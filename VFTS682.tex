...
\author{M.~Renzo$^{1}$\and S.~E.~de~Mink$^{1}$ \and \SdM{D.J. Lennon$^{2}$ et al.} \todo{... add coauthors...}%\and
...
\begin{abstract}
...\\
\SdM{Mathieu: please use emulate apj template for this.  We would be submitting there. }...\\
...\\
...\\
...\\
...\\
