...
% The case of VFTS682 has also spawned significant theoretical efforts
...
\todo{subsection on validation with HST data?Discussion on
  ...
  data for VFTS682 dont seem to be public.}
...
robustly exclude that VFTS682 is itself a merger, as already
...
upperlimit to the timescale to form the ``bully binary'' in
...
The variability of VFTS682, reminiscent of LBV stars, also suggests
...
The value of $\tau_\mathrm{kin}\simeq0.85$\,Myr we find for VFTS682 (see \Secref{sec:r136_origin}) is smaller
...
VFTS682 is the most massive runaway known to date, and its ejection
...
Telescope and Gaia observations will put constraints on the evolution
