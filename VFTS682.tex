...
\affil{$^{1}${\todo{check affil. num}Astronomical Institute Anton Pannekoek, University of
  ...
  $^{}$ {Armagh Observatory, College Hill, Armagh BT61 9DG, UK}\\
  $^{}$ {National Research Council, Herzberg Astronomy \&
    Astrophysics, 5071 West Saanich Road, Victoria, BC, V9E 2E7,
    Canada}\\
  $^{}$ {Argelander-Instit\"ut f\"ur Astronomie, Universit\"at Bonn, Auf dem H\"ugel 71, 53121, Bonn, Germany}
}
...
ejection very soon in the cluster evolution. \todo{address Norbert comments on age determination}.
