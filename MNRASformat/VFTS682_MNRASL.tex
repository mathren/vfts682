...
R136 of \newtext{$\sim$$1.3\,\mathrm{Myr}$}. If identified, such a binary % could be R145 according to \cite{fujii:11}, and it
...
$^4$ {Department of Physics \& Astronomy, Johns Hopkins University, Baltimore, MD 21218, USA}
  ...
  {   \tiny
    ...
    and VHB the NRC-Canada Plaskett Fellowship. This study has used data from the ESA mission {\it Gaia} (\url{https://www.cosmos.esa.int/gaia}), processed by the {\it Gaia} Data Processing and Analysis Consortium (DPAC, \url{https://www.cosmos.esa.int/web/gaia/dpac/consortium}).
  }
