...
\title[Space astrometry of the very massive
$\sim$$150\,M_\odot$ candidate runaway star VFTS682]{\emph{Gaia} and
  HST astrometry of the very massive $\sim$$150\,M_\odot$  candidate runaway star VFTS682}
...
\newauthor{A.~de~Koter$^{1,11}$,
      N.~Langer$^{12}$, F. Najarro$^{13}$, F.~R.~N.~Schneider$^{14}$, J.~S.~Vink$^{15}$}}

% These dates will be filled out by the publisher
\date{Accepted 2018 October 12. Received 2018 October 4; in original
  form 2018 August 28 \\ Affiliations
...
of the dissolution of dense groups.  However, a small but significant population
...
indicate that the dynamical ejection of very massive stars like VFTS682 is
...
parameters and measured a visual extinction of $A_V=4.45\pm0.12$, implying a
...
Variable (LBV) stars \citep{udalski:08, bestenlehner:11}. The source also
...
against over-interpreting the existing radial velocities estimates. \citet{bestenlehner:11} estimate a mass loss rate of
...
vicinity. This is in line with the expectation that the star was not
formed in situ. Given these issues, we refrain from using the RV measurements in this
...
\begin{figure}%[tbp]
  ...
  \caption{Distribution of OB-type and Wolf-Rayet stars in proper
    ...
    ejection (see \Secref{sec:results}). In both
...
proper motion of nearby stars with reliable astrometric data (see \Tabref{tab:vfts682}).  They
...
Therefore, their measurements provide a useful
complementary estimate of the proper motion of VFTS682 which is independent from the \emph{Gaia} data. 
...
(top panel) and the projected flight direction (bottom panel) relative
to R136 of
...
($0.7\pm0.1$\,Myr and $0.4^{+0.8}_{-0.4}$\,Myr for VFTS16 and VFTS72,
...
potentially the most massive
runaway known to date, with a two-dimensional
projected velocity with respect to R136 of
$38\pm17\kms$ (taking a weighted average of \emph{Gaia} DR2 and HST
...
from the disruption of a massive binary by a supernova is excluded. %  since the region is too young for stars
...
massive star among those interacting \cite[although the
...
and their simulation suggest a significant incidence of
 (dynamically driven) stellar mergers both in the cluster and among
 the stars ejected. Indeed, several %relatively
...
difference between the cluster age and the kinematic age of VFTS682 puts an
upper limit to the timescale to form the ``bully binary'' in
R136 of $\sim$$1.3\,\mathrm{Myr}$. % If identified, 
Such a binary % could be R145 according to \cite{fujii:11}, and it
might be a % an ideal observational
...
mass and thus their final fate \cite[e.g.,][]{vink:15}.
...
region. Studies of this population, enabled by recent and future %HST
% and \emph{Gaia}
...
% \vspace*{-30pt}
  ...
  { \small
    We thank P.~Crowther, J.~Heyl, M.\,C.\,Ram\'irez-Tannus, S.~N.~Shore,
    ...
    and VHB the NRC-Canada Plaskett Fellowship. This study has used data from the ESA mission {\it Gaia} (\url{https://www.cosmos.esa.int/gaia}), processed by % the {\it Gaia} Data Processing and Analysis Consortium (
...
\bibitem[\protect\citeauthoryear{{Cioni} et~al.,}{{Cioni}
  et~al.}{2011}]{cioni:11}
{Cioni} M.-R.~L.,  et~al., 2011, \mn@doi [\aap] {10.1051/0004-6361/201016137},
  \href {http://adsabs.harvard.edu/abs/2011A%26A...527A.116C} {527, A116}
...
\bibitem[\protect\citeauthoryear{{Drew}, {Herrero}, {Mohr-Smith},
  {Mongui{\'o}}, {Wright}, {Kupfer}  \& {Napiwotzki}}{{Drew}
  et~al.}{2018}]{drew:18}
{Drew} J.~E.,  {Herrero} A.,  {Mohr-Smith} M.,  {Mongui{\'o}} M.,  {Wright}
  N.~J.,  {Kupfer} T.,   {Napiwotzki} R.,  2018, \mn@doi [\mnras]
  {10.1093/mnras/sty1905}, \href
  {http://adsabs.harvard.edu/abs/2018MNRAS.tmp.1812D} {}
...
\bibitem[\protect\citeauthoryear{{Gaia Collaboration} et~al.,}{{Gaia
  Collaboration} et~al.}{2018}]{brown:18}
{Gaia Collaboration} et~al., 2018, \mn@doi [\aap]
  {10.1051/0004-6361/201833051}, \href
  {http://adsabs.harvard.edu/abs/2018A%26A...616A...1G} {616, A1}
...
\bibitem[\protect\citeauthoryear{{H{\'e}nault-Brunet}
  et~al.,}{{H{\'e}nault-Brunet} et~al.}{2012}]{henault-brunet:12}
{H{\'e}nault-Brunet} V.,  et~al., 2012, \mn@doi [\aap]
  {10.1051/0004-6361/201219472}, \href
  {http://adsabs.harvard.edu/abs/2012A%26A...545L...1H} {545, L1}
...
\bibitem[\protect\citeauthoryear{{Luks} \& {Rohlfs}}{{Luks} \&
  {Rohlfs}}{1992}]{luks:92}
{Luks} T.,  {Rohlfs} K.,  1992, \aap, \href
  {http://adsabs.harvard.edu/abs/1992A%26A...263...41L} {263, 41}

\bibitem[\protect\citeauthoryear{{Meixner} et~al.,}{{Meixner}
  et~al.}{2006}]{meixner:06}
{Meixner} M.,  et~al., 2006, \mn@doi [\aj] {10.1086/508185}, \href
  {http://adsabs.harvard.edu/abs/2006AJ....132.2268M} {132, 2268}
...
\bibitem[\protect\citeauthoryear{{Parker} \& {Goodwin}}{{Parker} \&
  {Goodwin}}{2007}]{parker:07}
{Parker} R.~J.,  {Goodwin} S.~P.,  2007, \mn@doi [\mnras]
  {10.1111/j.1365-2966.2007.12179.x}, \href
  {http://adsabs.harvard.edu/abs/2007MNRAS.380.1271P} {380, 1271}
...
{Platais} I.,  et~al., 2018, \mn@doi [\aj] {10.3847/1538-3881/aad280}, \href
  {http://adsabs.harvard.edu/abs/2018AJ....156...98P} {156, 98}
...
\bibitem[\protect\citeauthoryear{{Schneider}, {Langer}, {de Koter}, {Brott},
  {Izzard}  \& {Lau}}{{Schneider} et~al.}{2014}]{schneider:14}
{Schneider} F.~R.~N.,  {Langer} N.,  {de Koter} A.,  {Brott} I.,  {Izzard}
  R.~G.,   {Lau} H.~H.~B.,  2014, \mn@doi [\aap] {10.1051/0004-6361/201424286},
  \href {http://adsabs.harvard.edu/abs/2014A%26A...570A..66S} {570, A66}
...
\bibitem[\protect\citeauthoryear{{Townsley}, {Broos}, {Feigelson}, {Garmire}
  \& {Getman}}{{Townsley} et~al.}{2006}]{townsley:06}
{Townsley} L.~K.,  {Broos} P.~S.,  {Feigelson} E.~D.,  {Garmire} G.~P.,
  {Getman} K.~V.,  2006, \mn@doi [\aj] {10.1086/500535}, \href
  {http://adsabs.harvard.edu/abs/2006AJ....131.2164T} {131, 2164}

\bibitem[\protect\citeauthoryear{{Townsley}, {Broos}, {Garmire}, {Bouwman},
  {Povich}, {Feigelson}, {Getman}  \& {Kuhn}}{{Townsley}
  et~al.}{2014}]{townsley:14}
{Townsley} L.~K.,  {Broos} P.~S.,  {Garmire} G.~P.,  {Bouwman} J.,  {Povich}
  M.~S.,  {Feigelson} E.~D.,  {Getman} K.~V.,   {Kuhn} M.~A.,  2014, \mn@doi
  [\apjs] {10.1088/0067-0049/213/1/1}, \href
  {http://adsabs.harvard.edu/abs/2014ApJS..213....1T} {213, 1}
...
\bibitem[\protect\citeauthoryear{{Vink}}{{Vink}}{2015}]{vink:15}
{Vink} J.~S.,  2015, {Mass-Loss Rates of Very Massive Stars}.
Springer

\bibitem[\protect\citeauthoryear{{Walborn}, {Barb{\'a}}  \&
  {Sewi{\l}o}}{{Walborn} et~al.}{2013}]{walborn:13}
{Walborn} N.~R.,  {Barb{\'a}} R.~H.,   {Sewi{\l}o} M.~M.,  2013, \mn@doi [\aj]
  {10.1088/0004-6256/145/4/98}, \href
  {http://adsabs.harvard.edu/abs/2013AJ....145...98W} {145, 98}
...
\bibitem[\protect\citeauthoryear{{Woosley}}{{Woosley}}{2017}]{woosley:17}
{Woosley} S.~E.,  2017, \mn@doi [\apj] {10.3847/1538-4357/836/2/244}, \href
  {http://adsabs.harvard.edu/abs/2017ApJ...836..244W} {836, 244}
...
\noindent $^{2}$ {ESA, European Space Astronomy Centre, Apdo. de Correos 78,
    E-28691 Villanueva de la Ca\~nada, Madrid, Spain} 

  \noindent $^{3}$ {Instituto de Astrof\'isica de Canarias, E-38205 La Laguna, Tenerife, Spain}
 %Center for Astrophysical Sciences, 

  \noindent $^4$ {Department of Physics \& Astronomy, Johns Hopkins University, Baltimore, MD 21218, USA}

  \noindent $^{5}$ {Space Telescope Science Institute, 3700 San Martin Drive,
    Baltimore, MD 21218, USA}

  \noindent $^{6}${Department of Physics and Astronomy, Hicks Building,
    Hounsfield Road, University of Sheffield, Sheffield S3 7RH, UK}

  \noindent $^{7}${UK Astronomy Technology Centre, Royal Observatory Edinburgh, Blackford Hill, Edinburgh, EH9 3HJ, UK}

  \noindent $^{8}$ {National Research Council, Herzberg Astronomy \&
    Astrophysics, 5071 West Saanich Road, Victoria, BC, V9E 2E7,
    Canada}

  \noindent $^{9}$ {School of Astronomy \& Space Science, University of the Chinese
    Academy of Sciences, Beijing 100012, China}

  \noindent $^{10}$ {National Astronomical Observatories, Chinese Academy of
    Sciences, Beijing 100012, China}

  \noindent $^{11}$ {Institute of Astronomy, KU Leuven, Celestijnenlaan 200D, 3001 Leuven, Belgium}
  
  \noindent $^{12}$ {Argelander-Instit\"ut f\"ur Astronomie, Universit\"at Bonn,
    Auf dem H\"ugel 71, 53121, Bonn, Germany}

  \noindent $^{13}$ {Centro de Astrobiolog\'ia, CSIC-INTA, Carretera de Torrej\'on a Ajalvir km-4, E-28850 Torrej\'on de Ardoz, Madrid, Spain}

  \noindent $^{14}$ {Department of Physics, University of Oxford, Keble Road,
    Oxford OX13RH, UK} 

  \noindent $^{15}$ {Armagh Observatory, College Hill, Armagh BT619DG, UK}
