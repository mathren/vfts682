...
\newauthor{A.~de~Koter$^{1}$,
      N.~Langer$^{11}$, F. Najarro$^{12}$, F.~R.~N.~Schneider$^{13}$, J.~S.~Vink$^{14}$}}
...
from the disruption of a \newtext{massive} binary by a supernova is excluded. %  since the region is too young for stars
...
R136 of \newtext{$\sim$$1.3\,\mathrm{Myr}$}. % If identified, 
